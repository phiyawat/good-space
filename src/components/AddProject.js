  ...
  render() {
    return (
      <div>
        ...
        <div className="main">
          <Col className="App">ข้อมูลโครงการ</Col>
          <Row>
            <Col className="App3">
          ...
          <Row>
            <Col className="App3">
              ...
              <FormControl
                type="text"
                name="project_name"
                placeholder="ชื่อโครงการภาษาไทย/English"
              />
            </Col>
          </Row>
          <Row>
          ...
          <Row>
            <Col className="App3">
              ...
              <FormControl
                type="text"
                name="project_time"
                placeholder="ระยะเวลาของโครงการ"
              />
            </Col>
          </Row>
          <Row>
            <Col>
              <div>
                <Label className="App2">Project Manager</Label>
              </div>
              <Label>ชื่อ-สกุล</Label>
              <FormControl
                type="text"
                name="pm_name"
                placeholder="ชื่อ-สกุล Project Manager"
              />
            </Col>
          </Row>
          <Row>
            <Col className="App3">
              ...
              <FormControl
                type="text"
                name="pm_tel"
                placeholder="เบอร์ติดต่อ Project Manager"
              />
            </Col>
          </Row>
          <div className="App3">
